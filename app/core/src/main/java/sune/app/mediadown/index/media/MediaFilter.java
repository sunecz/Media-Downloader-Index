...
import sune.app.mediadown.index.util.Opt.OptPredicate;
...
public final class MediaFilter {
	...
	public static MediaFilter.Builder builder() {
		return new Builder();
	}
	
	public static MediaFilter of(Comparator<Media> comparator) {
		return of(comparator, null);
	}
	
	public static MediaFilter of(Comparator<Media> comparator, Predicate<Media> filter) {
		return comparator != null ? new MediaFilter(comparator, filter) : none();
	}
	
	public static MediaFilter none() {
	...
	public static final class Builder {
		...
		private final PriorityHolder<MediaFormat> formatPriority;
		private boolean bestQuality;
		private final PriorityHolder<MediaQuality> qualityPriority;
		...
		private List<ComparisonOrder> mergedComparisonOrder() {
	...
	private static final class MediaFormatComparator extends PriorityComparator<Media, MediaFormat> {
		...
		public static MediaFormatComparator ofPriority(Builder.PriorityHolder<MediaFormat> holder) {
	...
	private static final class MediaQualityComparator extends PriorityComparatorOfComparable<Media, MediaQuality> {
		...
		public static MediaQualityComparator ofPriority(Builder.PriorityHolder<MediaQuality> holder) {
			return new MediaQualityComparator(
				holder.priority(), holder.priorityReversed(), holder.naturalReversed(), holder.preferred()
			);
		}
		
		public static MediaQualityComparator naturalReversed() {
