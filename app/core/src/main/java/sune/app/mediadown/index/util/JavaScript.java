...
import sune.app.mediadown.index.util.JSON.JSONCollection;
...
public final class JavaScript {
	...
	public static Object execute(String jsFile, String js) throws IOException, ScriptException {
		StringJoiner.reset();
	...
	public static String decodeXChars(String string) {
	...
	public static String varcontent(String script, String name) {
		StringBuilder sb = new StringBuilder();
	...
	public static Map<String, String> varcontents(String script) {
	...
	public static JSONCollection readObject(String string) {
		try {
	 ...
	 */
	private static int isBracketChar(int c) {
	...
	private static boolean isVarContentClosingChar(int c) {
		return c == ';' || c == '<'; // '<' for HTML script tag
	}
	
	public static int varContentEndIndex(String string, int start) {
