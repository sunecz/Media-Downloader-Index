...
public final class MediaFormat {
	...
	private static void register(MediaFormat format) {
	...
	private static Stream<MediaFormat> allFormats() {
	...
	private static MediaFormat[] newValues() {
		return allFormats().toArray(MediaFormat[]::new);
	}
	
	private static MediaFormat[] newOutputFormats() {
		return allFormats().filter(MediaFormat::isOutputFormat).toArray(MediaFormat[]::new);
	}
	
	private static <T> MediaFormat filter(BiFunction<MediaFormat, T, Boolean> predicate, T value) {
	...
	public static MediaFormat ofName(String name) {
	...
	public static MediaFormat fromPath(Path path) {
		return fromPath(path.getFileName().toString());
	}
	
	public static MediaFormat fromPath(String path) {
		return fromExtension(Utils.OfPath.info(path).extension());
	}
	
	public static MediaFormat fromName(String string) {
	...
	public static MediaFormat[] outputFormats() {
