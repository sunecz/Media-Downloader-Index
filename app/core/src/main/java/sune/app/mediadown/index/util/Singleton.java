...
public final class Singleton {
	...
	private static boolean notInSingleton(StackFrame frame) {
		return frame.getDeclaringClass() != Singleton.class;
	}
	
	private static String signature(Object instance, String name) {
		return String.format("%d:%s", System.identityHashCode(instance), name);
	}
	
	private static String signature(Object instance, StackFrame frame) {
		return String.format("%d:%s.%s%s", System.identityHashCode(instance), frame.getClassName(),
		                     frame.getMethodName(), frame.getDescriptor());
	}
	
	private static String context(Object instance, String name) {
	...
	private static <T> T store(Object instance, String name, Supplier<T> supplier) {
	...
	private static void discard(Object instance, String name) {
		singletons.remove(context(instance, name));
	}
	
	public static <T> T ofStatic(T value) {
		return ofStatic(null, value);
	}
	
	public static <T> T ofStatic(String name, T value) {
		return ofStatic(name, () -> value);
	}
	
	public static <T> T ofStatic(Supplier<T> value) {
		return ofStatic(null, value);
	}
	
	public static <T> T ofStatic(String name, Supplier<T> value) {
		return store(null, name, Objects.requireNonNull(value));
	}
	
	public static <T> T of(Object instance, T value) {
		return of(instance, null, value);
	}
	
	public static <T> T of(Object instance, String name, T value) {
		return of(Objects.requireNonNull(instance), name, () -> value);
	}
	
	public static <T> T of(Object instance, Supplier<T> value) {
		return of(instance, null, value);
	}
	
	public static <T> T of(Object instance, String name, Supplier<T> value) {
		return store(Objects.requireNonNull(instance), name, Objects.requireNonNull(value));
	}
	
	public static void removeStatic(String name) {
		discard(null, name);
	}
	
	public static void remove(Object instance, String name) {
