...
import sune.app.mediadown.index.util.ComparatorCombiner;
...
public final class MediaQuality implements Comparable<MediaQuality> {
	...
	private static QualityValue requireValidValue(QualityValue value, MediaType mediaType) {
	...
	private static void register(MediaQuality quality) {
	...
	private static Stream<MediaQuality> unmodifiedQualities() {
	...
	private static boolean isModified(MediaQuality quality) {
	...
	public static boolean equalNames(MediaQuality a, MediaQuality b) {
	 ...
	 */
	public static Comparator<MediaQuality> reversedComparatorKeepOrder() {
	...
	public static MediaQuality ofName(String name) {
	...
	public static MediaQuality fromString(String quality, MediaType mediaType) {
	...
	public static MediaQuality fromResolution(MediaResolution resolution) {
	...
	public static MediaQuality fromSampleRate(int sampleRate) {
	...
	public static MediaQuality[] validQualities() {
		return validQualities.value();
	}
	
	public static void addStringParser(MediaQualityParser parser) {
		parsers.add(Objects.requireNonNull(parser));
	}
	
	private static Builder builder(boolean isUnknown) {
	...
	public static class VideoQualityValue extends QualityValue {
		...
		@Override
		public int compareTo(QualityValue qv) {
			if(this == qv || !(qv instanceof VideoQualityValue other))
				return 0;
	...
	public static class AudioQualityValue extends QualityValue {
		...
		@Override
		public int compareTo(QualityValue qv) {
			if(this == qv || !(qv instanceof AudioQualityValue other))
				return 0;
	...
	public interface MediaQualityParser {
