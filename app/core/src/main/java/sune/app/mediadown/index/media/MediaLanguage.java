...
public final class MediaLanguage {
	...
	private static void register(MediaLanguage language) {
	...
	private static Stream<MediaLanguage> allLanguages() {
	...
	private static MediaLanguage[] newValues() {
		return allLanguages().toArray(MediaLanguage[]::new);
	}
	
	private static MediaLanguage[] newDeterminedLanguages() {
		return allLanguages()
					.filter((l) -> !l.isAnyOf(MediaLanguage.UNKNOWN, MediaLanguage.UNDETERMINED))
					.toArray(MediaLanguage[]::new);
	}
	
	public static MediaLanguage[] values() {
		return values.value();
	}
	
	public static MediaLanguage[] determinedLanguages() {
		return determinedLanguages.value();
	}
	
	public static MediaLanguage ofName(String name) {
	...
	public static MediaLanguage ofCodes(Set<String> codes) {
